...
// Source: github.com/kenethrrizzo/banking/domain/repositories (interfaces: AccountRepository)
...
import (
	...
	entities "github.com/kenethrrizzo/banking/domain/entities"
...
func (m *MockAccountRepository) FindById(arg0 string) (*entities.Account, *errs.AppError) {
	m.ctrl.T.Helper()
...
func (m *MockAccountRepository) Save(arg0 entities.Account) (*entities.Account, *errs.AppError) {
	m.ctrl.T.Helper()
...
func (m *MockAccountRepository) SaveTransaction(arg0 entities.Transaction) (*entities.Transaction, *errs.AppError) {
	m.ctrl.T.Helper()
